...
<?php
$_SESSION['upload_folder'] = "_files";
?>

<form class="uploadForm" action="submit.php" method="post" enctype="multipart/form-data">
    <img src="images/upload_file_1.png" alt="upload_file_1">
    <h2>Upload file</h2>
    <label for="file">Filename:</label>
    <input type="file" name="file" id="file">
    <input type="submit" name="submit" value="Submit" id="submitUpload">
    <input type="hidden" name="upload_dir" value="<?php echo $_SESSION['upload_folder'] ?>">
    <!--this one is needed (type="hidden" name="link" value="_upload")-->
    <!--<input type="hidden" name="link" value="_upload">--> 
</form>
...
function list_files() {
    ...
    sort($files1);
//    echo "files_length". sizeof($files1);
    echo "<div class='uploadForm'>";
    ...
    foreach ($files1 as $file_act) {
        ...
        echo "<td class='colW_1'><a href='$path' target='_blank' class='downloadLink'>$file_act</a></td>";
